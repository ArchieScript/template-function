    ...
    local function MODULE(file);
        ...
        if not A.VersArcFun("2.8.2",file,'')then A.no_undo()return;end;local Arc=E;
    end;MODULE((reaper.GetResourcePath()..'/Scripts/Archie-ReaScripts/Functions/Arc_Function_lua.lua'):gsub('\\','/'));
