...
##### [string.gmatch](https://github.com/ArchieScript/template-function/blob/master/string.gmatch)  [Описание](http://uopilot.tati.pro/index.php?title=String.gmatch_(Lua))
